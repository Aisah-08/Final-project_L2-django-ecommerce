...
PILIHAN_KATEGORI = (("S", "Shirt"), ("SW", "Sport wear"), ("OW", "Outwear"))
...
class ProdukItem(models.Model):
    ...
    def get_add_to_cart_url(self):
        return reverse("toko:add-to-cart", kwargs={"slug": self.slug})

    def get_remove_from_cart_url(self):
        return reverse("toko:remove-from-cart", kwargs={"slug": self.slug})
